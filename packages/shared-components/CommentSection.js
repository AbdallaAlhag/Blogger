...
export function CommentSection({ comments: initialComments, blogId }) {
  ...
  return _jsxs('div', {
    ...
    children: [
          ...
          _jsxs('div', {
            children: [
              ...
              _jsx('input', {
                ...
                className:
                  'mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 p-2',
                required: true,
              }),
            ],
          }),
          _jsxs('div', {
            children: [
              ...
              _jsx('textarea', {
                ...
                className:
                  'mt-1 block w-full rounded-md border border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 p-2 resize-none',
                rows: 3,
                required: true,
              }),
            ],
      ...
      _jsx('h2', { className: 'text-2xl font-bold', children: 'Comments' }),
      _jsx('div', {
        ...
        children:
          comments.length > 0
            ...
            : _jsx('p', {
                ...
                children: 'No comments, be the first!',
              }),
      }),
    ],
  });
